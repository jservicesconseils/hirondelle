...
import {
  transition
} from "./chunk-7CQT7WVV.js";
import {
  createLockController
} from "./chunk-QEX24SFT.js";
import "./chunk-VZXYYFOL.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-TKORYL2U.js";
import {
  createColorClasses,
  hostContext
} from "./chunk-X65TN4FR.js";
import {
  getIonMode,
  isPlatform
} from "./chunk-X5ASXK7S.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
...
} from "./chunk-6BHDI6VM.js";
import {
  shouldUseCloseWatcher
} from "./chunk-OHB6INPP.js";
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./chunk-7A3IN2EX.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./chunk-UUWUOKWK.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./chunk-VUAJQSPP.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./chunk-KGITXY6V.js");
        ...
        if (typeof window !== "undefined") {
          import("./chunk-TUI7AWOC.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./chunk-7OI27UJ3.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
  /**
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./chunk-6VE6RW3Y.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6LLEKJWF.js.map
