...
app.get('/health', (_req, res) => {
  res.json({
    ...
    routes: {
      ...
      '/api/v1/auth': config.memberTarget,
      '/api/v1/settings': config.memberTarget,
      '*': config.eventTarget,
    },
  });
});
...
const MEMBER_PREFIXES = ['/api/v1/members', '/api/v1/groups', '/api/v1/me', '/api/v1/auth', '/api/v1/settings'];
